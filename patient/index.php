            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Book A service</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                ...
                <tr>
                    ...
                    <tr>
    <td>
        <h3>Welcome to Kigali Medical Center!</h3>
        <h1><?php echo $username; ?></h1>
        <p>
            This is our official online booking system.  
            View our <a href="doctors.php" class="non-style-link"><b>doctors</b></a>,  
            check <a href="schedule.php" class="non-style-link"><b>available services</b></a>,  
