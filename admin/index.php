            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $schedulerow = $database->query("select  * from  schedule where scheduleday='$today';");
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                            $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduleday,schedule.timerange,schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid  where schedule.scheduleday>='$today' and schedule.scheduleday<='$nextweek' order by schedule.scheduleday desc"; 
                                                $result= $database->query($sqlmain);
                                                ...
                                                for ( $x=0; $x<$result->num_rows;$x++){
                                                    ...
                                                    echo '<tr>
                                                        ...
                                                        <td style="text-align:center;">
                                                            '.substr($scheduleday,0,10).' '.substr($timerange,0,5).'
                                                        </td>
