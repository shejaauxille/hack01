            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr>
                    ...
                    <td width="15%">
                        ...
                        <p class="heading-sub12" style="padding: 0;margin: 0;">
                            ...
                            $today = date('Y-m-d');
                            echo $today;
                            // Use the correct column name 'scheduleday' here
                ...
                <tr>
                    <td colspan="4" >
                        ...
                        <a href="?action=add-session&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="margin-left:25px;background-image: url('../img/icons/add.svg');">Add a Session</button></a>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <?php
                    if($_POST){
                        $sqlpt1="";
                        // Corrected variable name check
                        if(!empty($_POST["scheduleday"])){
                            $scheduleday=$_POST["scheduleday"];
                            // Corrected column name in the WHERE clause
                            $sqlpt1=" schedule.scheduleday='$scheduleday' ";
                        }
                        $sqlpt2="";
                        ...
                        $sqlmain= "select schedule.scheduleid, schedule.title, doctor.docname, schedule.scheduleday, schedule.timerange, schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid ";
                        ...
                        // Corrected the column name in the ORDER BY clause
                        $sqlmain= "select schedule.scheduleid, schedule.title, doctor.docname, schedule.scheduleday, schedule.timerange, schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid  order by schedule.scheduleday desc";
                    }
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                        ...
                        <center>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="scheduleday" class="form-label">Session Day : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="scheduleday" class="box" required>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="timerange" class="form-label">Time Range (e.g., 08:00 AM - 01:00 PM): </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="timerange" class="input-text" placeholder="08:00 AM - 01:00 PM" required><br>
                                </td>
                            </tr>
            ...
            // Corrected scheduledate to scheduleday
            $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduleday,schedule.timerange,schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid  where  schedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $docname=$row["docname"];
            $scheduleid=$row["scheduleid"];
            ...
            <div id="popup1" class="overlay">
                        ...
                        <center>
                            ...
                            <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <label for="nic" class="form-label">Scheduled Day: </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <label for="Tele" class="form-label">Scheduled Time Range: </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
